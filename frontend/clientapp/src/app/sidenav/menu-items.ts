...
let austinMenu = new NavItem(null, 'Select Location', null, [austin, travisCounty, texas, unitedStates, nonGovernment]);
...
let betaLocationMenu = new NavItem(null, 'Select Location', null, [boothbayHarbor, lincolnCounty]);
